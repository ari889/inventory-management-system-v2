    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <x-form.textbox labelName="Unit Discount" name="edit_discount" required="required" col="col-md-12 mb-3" />
...
<script>
    $(document).ready(function () {
        ...
        $('#product-list').on('click', '.edit-product', function(){
            ...
            var row_product_name = $('#product-list tr:nth-child('+(rowindex + 1)+')').find('td:nth-child(1)').text();
            var row_product_code = $('#product-list tr:nth-child('+(rowindex + 1)+')').find('td:nth-child(2)').text();
