    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex flex-row justify-content-between align-items-center">
                ...
                <button type="button" class="btn btn-primary btn-sm" onclick="showFormModal('Add new account', 'Save')">
            ...
            <form id="form-filter">
                <div class="row">
                    <div class="col-md-4">
                        <label for="account_no" class="mb-2">Account Number</label>
...
@if(permission('account-edit') || permission('account-add'))
            ...
            if (id) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#store_or_update_form #accounnt_no').val(data.accounnt_no);
