...
@section('content')
    ...
    <div class="row">
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-row justify-content-between align-items-center">
                    ...
                    @if (permission('payroll-add'))
                        <button type="button" class="btn btn-primary btn-sm"
                            onclick="showFormModal('Add new payroll', 'Save')">
                ...
                <form id="form-filter">
                    <div class="row">
                        <x-form.selectbox labelName="Employee" name="employee_id" required="required" col="col-md-3"
                            class="selectpicker">
                        ...
                        <x-form.textbox labelName="From Date" name="from_date" required="required" col="col-md-3"
                            class="date" />
                        <x-form.textbox labelName="To Date" name="to_date" required="required" col="col-md-3"
                            class="date" />
    ...
    @if (permission('payroll-edit') || permission('payroll-add'))
