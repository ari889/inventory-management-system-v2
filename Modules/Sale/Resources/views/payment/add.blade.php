    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary">
                <h4 class="modal-title text-white" id="model-1"></h4>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <x-form.selectbox labelName="Payment Method" name="payment_method" required="required"
                            col="col-md-12 mb-2" class="selectpicker">
                            @foreach (PAYMENT_METHOD as $key => $value)
                                <option value="{{ $key }}">{{ $value }}</option>
                            @endforeach
                        </x-form.selectbox>
                        <x-form.selectbox labelName="Account" name="account_id" required="required" col="col-md-12 mb-2"
                            class="selectpicker">
                            @if (!$accounts->isEmpty())
                        ...
                        <div class="form-group col-md-12 mb-2 payment_no d-none">
