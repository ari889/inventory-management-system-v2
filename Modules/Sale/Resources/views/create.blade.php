            ...
            <div class="card-body">
                ...
                <form id="sale-form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <x-form.selectbox labelName="Customer" name="customer_id" required="required" col="col-md-6 mb-3"
                            class="selectpicker">
                        ...
                        <div class="col-md-4 d-none payment_status required mb-2">
                        ...
                        <div class="payment col-md-12 d-none">
                            <div class="row">
                                ...
                                <div class="col-md-4 payment_no d-none mb-2">
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="change_amount" id="change_amount"
                                        readonly>
                                </div>
    ...
    <script>
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        <button type="button" class="btn btn-danger btn-sm remove-product"><i class="fas fa-trash"></i></button></td>`;
                            ...
                            console.log(parseFloat(data.price) + parseFloat(data.price *
                                customer_group_rate));
            ...
            $('#paid_amount').on('input', function() {
                ...
                $('#change_amount').val((parseFloat($('#paying_amount').val()) - parseFloat($(
                    '#paid_amount').val())).toFixed(2));
            });
