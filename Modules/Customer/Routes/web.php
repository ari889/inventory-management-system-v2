...
Route::group(['middleware' => ['auth']], function(){
    ...
    Route::group(['prefix' => 'customer', 'as' => 'customer.'], function(){
        ...
        Route::post('store-or-update', 'CustomerController@store_or_update')->name('store.or.update');
        ...
        Route::get('group-data/{id}','CustomerController@groupData')->name('customer.group.data');
    });
});
