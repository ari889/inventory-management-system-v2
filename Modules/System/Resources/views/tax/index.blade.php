    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex flex-row justify-content-between align-items-center">
                ...
                <button type="button" class="btn btn-primary btn-sm" onclick="showFormModal('Add new tax', 'Save')">
            ...
            <form id="form-filter">
                <div class="row">
                    <div class="col-md-4">
                        <label for="name" class="mb-2">Tax Name</label>
                        <input type="text" name="name" id="name" class="form-control" placeholder="Enter tax name">
                    </div>
                    <div class="col-md-4">
                        <label for="rate" class="mb-2">Tax Rate</label>
                        <input type="text" name="rate" id="rate" class="form-control" placeholder="Enter tax rate">
                    </div>
...
@if(permission('tax-edit') || permission('tax-add'))
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                ...
                "data": function (data) {
                    ...
                    data.rate = $('#form-filter #rate').val();
                    data._token = _token;
                }
            },
            "columnDefs": [{
