    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex flex-row justify-content-between align-items-center">
                ...
                <button type="button" class="btn btn-primary btn-sm" onclick="showFormModal('Add new warehouse', 'Save')">
            ...
            <form id="form-filter">
                <div class="row">
                    <div class="col-md-4">
                        <label for="name" class="mb-2">Warehouse Name</label>
                        <input type="text" name="name" id="name" class="form-control" placeholder="Enter tax name">
                    </div>
                    <div class="col-md-4">
                        <label for="phone" class="mb-2">Warehouse Phone</label>
                        <input type="text" name="phone" id="phone" class="form-control" placeholder="Enter phone">
                    </div>
                    <div class="col-md-4">
                        <label for="email" class="mb-2">Warehouse Email</label>
...
@if(permission('warehouse-edit') || permission('warehouse-add'))
