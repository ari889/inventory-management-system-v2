    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex flex-row justify-content-between align-items-center">
                ...
                <button type="button" class="btn btn-primary btn-sm" onclick="showFormModal('Add new customer group', 'Save')">
            ...
            <form id="form-filter">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="group_name" id="group_name" class="form-control" placeholder="Enter user name">
                    </div>
                    <div class="col-md-4">
                        <label for="percentage" class="mb-2">Percentage(%)</label>
                        <input type="text" name="percentage" id="percentage" class="form-control" placeholder="Enter user name">
                    </div>
...
@if(permission('customer-group-edit') || permission('customer-group-add'))
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                ...
                "data": function (data) {
                    ...
                    data.percentage = $('#form-filter #percentage').val();
                    data._token = _token;
                }
            },
            "columnDefs": [{
