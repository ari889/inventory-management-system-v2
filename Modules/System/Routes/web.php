...
Route::group(['middleware' => ['auth']], function(){
    ...
    Route::group(['prefix' => 'brand', 'as' => 'brand.'], function(){
        ...
        Route::post('store-or-update', 'BrandController@store_or_update')->name('store.or.update');
    ...
    Route::group(['prefix' => 'warehouse', 'as' => 'warehouse.'], function(){
        ...
        Route::post('store-or-update', 'WarehouseController@store_or_update')->name('store.or.update');
    ...
    Route::group(['middleware' => ['auth']], function(){
        ...
        Route::group(['prefix' => 'customer-group', 'as' => 'customer.group.'], function(){
            ...
            Route::post('store-or-update', 'CustomerGroupController@store_or_update')->name('store.or.update');
    ...
    Route::group(['middleware' => ['auth']], function(){
        ...
        Route::group(['prefix' => 'unit', 'as' => 'unit.'], function(){
            ...
            Route::post('store-or-update', 'UnitController@store_or_update')->name('store.or.update');
