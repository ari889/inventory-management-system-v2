<div style="width: 100%;">
    <button type="button" class="btn btn-warning btn-sm float-right mb-5" id="print-barcode"> <i
                ...
                <td>
                    <div style="text-align: center;width:{{ $width ? $width : '38' }}{{ $unit ? $unit : 'mm' }};
                        ...
                        <div style="width:100%;text-align:center;">
                            <img src="{{ 'data:image/png;base64,'.DNS1D::getBarcodePNG($code,$barcode_symbology) }}"
