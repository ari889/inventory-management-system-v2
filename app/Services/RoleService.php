...
class RoleService extends BaseService{
        ...
        if($request->ajax()){
            ...
            foreach ($list as $value) {
                ...
                if(permission('role-view')){
                    $action .= '<a href="'.route('role.view', ['id' => $value->id]).'" class="dropdown-item edit_data" data-id="'.$value->id.'"><i class="fas fa-eye text-warning"></i> View</a>';
                }
                ...
                if(permission('role-edit')){
                    $action .= '<a href="'.route('role.edit', ['id' => $value->id]).'" class="dropdown-item edit_data" data-id="'.$value->id.'"><i class="fas fa-edit text-primary"></i> Edit</a>';
                }
    ...
    public function edit(int $id){
        $role = $this->role->find_with_module_permission($id);
    ...
    public function delete(Request $request){
        $role = $this->role->find_with_module_permission($request->id);
